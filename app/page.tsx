...
import FreeObjectInspectorPanel from "./components/editor/FreeObjectInspectorPanel";
  ...
  return (
    <div className="app-shell">
      ...
      <section className={`workspace ${
        ...
        >
          {templateId === "free" && !showReview ? (
            <FreeObjectInspectorPanel
              selectedObject={selectedObject}
              selectedObjectIds={selectedObjectIds}
              freeTransformMode={freeTransformMode}
              selectedObjectKindLabel={
                selectedObject ? OBJECT_KIND_LABELS[selectedObject.kind] : null
              }
              selectedObjectDescription={
                selectedObject ? objectKindDescription(selectedObject) : null
              }
              canExport={canExport}
              volumeCm3={volumeCm3}
              onTransformModeChange={setFreeTransformMode}
              onAlignSelectedObjects={alignSelectedObjects}
              ...
              onUpdateObjectById={updateObjectById}
              onToggleObjectState={toggleObjectState}
              onOpenLibrary={() => setFreeEditorView("create")}
              onOpenDesignGallery={() => setShowDesignGallery(true)}
            />
          ) : (
            <>
